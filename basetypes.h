...
#define ERR_OUT_OF_RESOURCES                4
#define ERR_OUT_OF_MEMORY                   5
#define ERR_FILE_OPEN                       6
#define ERR_FILE_READ                       7
#define ERR_FILE_WRITE                      8
#define ERR_ITEM_NOT_FOUND                  9
#define ERR_UNKNOWN_ITEM_TYPE               10
#define ERR_INVALID_FLASH_DESCRIPTOR        11
#define ERR_INVALID_REGION                  12
#define ERR_EMPTY_REGION                    13
#define ERR_BIOS_REGION_NOT_FOUND           14
#define ERR_VOLUMES_NOT_FOUND               15
#define ERR_INVALID_VOLUME                  16
#define ERR_VOLUME_REVISION_NOT_SUPPORTED   17
#define ERR_VOLUME_GROW_FAILED              18
#define ERR_UNKNOWN_FFS                     19
#define ERR_INVALID_FILE                    20
#define ERR_INVALID_SECTION                 21
#define ERR_UNKNOWN_SECTION                 22
#define ERR_STANDARD_COMPRESSION_FAILED     23
#define ERR_CUSTOMIZED_COMPRESSION_FAILED   24
#define ERR_STANDARD_DECOMPRESSION_FAILED   25
#define ERR_CUSTOMIZED_DECOMPRESSION_FAILED 26
#define ERR_UNKNOWN_COMPRESSION_ALGORITHM   27
#define ERR_UNKNOWN_EXTRACT_MODE            28
#define ERR_UNKNOWN_INSERT_MODE             29
#define ERR_UNKNOWN_IMAGE_TYPE              30
#define ERR_UNKNOWN_PE_OPTIONAL_HEADER_TYPE 31
#define ERR_UNKNOWN_RELOCATION_TYPE         32
#define ERR_GENERIC_CALL_NOT_SUPPORTED      33
#define ERR_VOLUME_BASE_NOT_FOUND           34
#define ERR_PEI_CORE_ENTRY_POINT_NOT_FOUND  35
#define ERR_COMPLEX_BLOCK_MAP               36
#define ERR_DIR_ALREADY_EXIST               37
#define ERR_DIR_NOT_EXIST                   38
#define ERR_DIR_CREATE                      39
#define ERR_FILE_NOT_FOUND                  40
#define ERR_FILE_EXISTS                     41
#define ERR_REPLACE                         42
#define ERR_RELOCATION                      43
